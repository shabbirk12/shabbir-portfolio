  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 150 36" className="h-6 sm:h-7 w-auto fill-current">
        ...
        <text x="114" y="21" fontFamily="monospace" fontSize="11" fontWeight="bold" fill="var(--color-lime, #c6ff3d)">
          09
        </text>
      </svg>
    ),
  ...
  return (
    <section className="relative py-12 border-t border-line overflow-hidden bg-surface/10">
      ...
      <div
        ...
        style={{
          background: "linear-gradient(to right, var(--color-ink, #0a0a0a), transparent)",
        }}
      />
      <div
        className="pointer-events-none absolute inset-y-0 right-0 w-24 sm:w-40 z-10"
        style={{
          background: "linear-gradient(to left, var(--color-ink, #0a0a0a), transparent)",
        }}
      />
